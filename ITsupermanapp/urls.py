...
# like追加
from .views import TopPage, save_history, PostDetail, searchfunc, like, AllContents, categoryfunc, CreateView, LoginView, MypageView, LogoutView, RankingList
...
urlpatterns = [
    ...
    path('post/<int:pk>/detail', PostDetail.as_view(), name='PostDetail'),
    # likeへのディスパッチャ
